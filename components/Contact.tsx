...
export default function Contact() {
  ...
  return (
    ...
    >
        ...
        <textarea name="message" className="h-52 my-3 rounded-lg border border-black/10 p-4 " required maxLength={500} placeholder="Your message or any relevant details for our first meeting?"/>
